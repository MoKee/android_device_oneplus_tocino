...
TARGET_PREBUILT_KERNEL := device/oneplus/tocino/kernel
...
TARGET_PREBUILT_KERNEL := device/oneplus/OnePlus2/recovery/kernel
TARGET_RECOVERY_INITRC := device/oneplus/OnePlus2/recovery/etc/init.rc
...
# USB
TARGET_USE_CUSTOM_LUN_FILE_PATH := /sys/devices/soc.0/f9200000.ssusb/f9200000.dwc3/gadget/lun0/file
